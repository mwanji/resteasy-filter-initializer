package com.moandjiezana.resteasy.plugins.servlet;
...
public class ResteasyFilterInitializer implements
		ServletContainerInitializer {
	   private final static Set<String> ignoredPackages = new HashSet<String>();
	   ...
	   protected void register(Class<?> applicationClass, Set<Class<?>> providers, Set<Class<?>> resources, ServletContext servletContext)
	   {
	      ...
	      FilterRegistration.Dynamic reg = servletContext.addFilter(FilterDispatcher.class.getName(), Filter30Dispatcher.class);
	      ...
	      if (path != null)
	      {
	         ...
	         reg.addMappingForUrlPatterns(EnumSet.allOf(DispatcherType.class), true, mapping);
	      }
